...
import com.example.huynhat.snoozeit.R;
...
/**
 * Created by huynhat on 2018-01-08.
 */

public class FetchDistance extends AsyncTask<Location, Void, Double> {
    ...
    FetchDistance(Context applicationContext, OnTaskCompleted listener) {
